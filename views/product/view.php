                    ...
                    <div class="col-sm-7">
                        <div class="product-information"><!--/product-information-->
                            ...
                            <?php if ($product->sale == '1'): ?>
                                <?=  Html::img('@web/images/product-details/sale.png', ['class' => 'newarrival']) ?>
                            <?php endif; ?>
...
<!--                            <p><b>Condition:</b> New</p>-->
                            <p><b>Brand:</b><a href="<?= Url::to(['category/view', 'id' => $product->category->id]) ?>"><?php echo ' ' . $product->category->name ?></a></p>
